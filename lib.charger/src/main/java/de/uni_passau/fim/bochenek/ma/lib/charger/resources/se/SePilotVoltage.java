...
public class SePilotVoltage extends CoapResource implements HalResource {

	private double pilotVoltage;

	public SePilotVoltage(String name) {
		super(name);
	...
	public HalRepresentationBuilder representationBuilder() {
		...
		hal.addProperty("pilotVoltage", pilotVoltage);
